inherited Frm_MateriaPrima: TFrm_MateriaPrima
  ...
  inherited lblTitulo: TLabel
    Width = 750
    Caption = '         CADASTRO DE INSUMO (MAT'#201'RIA - PRIMA)'
    ExplicitWidth = 707
  end
  ...
  object cdsFornecedor: TClientDataSet
    Aggregates = <>
    DataSetField = cdsfdqryProdutoFornecedor
    Params = <>
    Left = 224
    Top = 507
    ...
    object cdsFornecedorID_PRODUTO: TIntegerField
      FieldName = 'ID_PRODUTO'
      Origin = 'ID_PRODUTO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object cdsFornecedorPRECO: TFMTBCDField
      FieldName = 'PRECO'
      Origin = 'PRECO'
      Precision = 18
      Size = 2
    end
    object cdsFornecedorREFERENCIA_FORNEC: TStringField
      FieldName = 'REFERENCIA_FORNEC'
      Origin = 'REFERENCIA_FORNEC'
      Size = 50
    end
    object cdsFornecedorRAZAO_NOME: TStringField
  ...
  object cdsHistVenda: TClientDataSet
    ...
    object cdsHistVendaDATA: TDateField
      DisplayLabel = 'IN'#205'CIO VIG'#202'NCIA'
      FieldName = 'DATA'
      Origin = '"DATA"'
      Required = True
    end
