...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, UPdr_Cad2, Data.DB, System.Actions,
  Vcl.ActnList, Datasnap.DBClient, Vcl.Buttons, Vcl.ExtCtrls,
...
begin
  ...
  begin
    DM.SMCadastroClient.setSubGrupoProdutos(dm.BancoDados,
       mCodigo,cds.Delta) ;
...
begin
  ...
  if cds.ChangeCount > 0 then
  begin
    mRetorno := DM.SMCadastroClient.setSubGrupoProdutos(DM.BancoDados,
