...
//            IfThen(MultaValorFixo, PercentualMulta, TruncTo((ValorDocumento*( 1+ PercentualMulta/100)-ValorDocumento),2)  ), 'R$ #,##0.00') +
//                         ' após o vencimento.'));
                                                    //Diego - Comentei linhas acima e adicionei linha abaixo
         AStringList.Add(ACBrStr('Multa de ' +FormatFloatBr(PercentualMulta,'#,##0.00 %')+' a partir de '+
                                 FormatDateTime('dd/mm/yyyy',DataMulta)));
      end;
