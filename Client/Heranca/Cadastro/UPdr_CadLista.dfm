inherited Pdr_CadLista: TPdr_CadLista
  BorderStyle = bsNone
  Caption = 'Pdr_CadLista'
  ClientHeight = 540
  ClientWidth = 585
  ...
  object dsLista: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 181
    Top = 141
  end
  object dsPrincipal: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 245
    Top = 141
  end
  object sLista: TDataSource
    DataSet = dsLista
    Left = 181
    Top = 205
  end
  object sPrincipal: TDataSource
    DataSet = dsPrincipal
    OnStateChange = sPrincipalStateChange
    Left = 245
    Top = 205
  end
