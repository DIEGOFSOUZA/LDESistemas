inherited Frm_Representante: TFrm_Representante
      ...
      object PageControl1: TPageControl
        ...
        object TabSheet1: TTabSheet
          ...
          object pnlTopo: TPanel
            ...
            object dbedtPERCENT_COMISSAO: TDBEdit
              Left = 496
              Top = 73
              Width = 73
              Height = 25
  ...
  inherited cds: TClientDataSet
    CommandText = 
      'SELECT r.CODIGO, r.CPF, r.RG, r.NOME, r.EMAIL, r.SITE, r.DDD_FON' +
      'E, r.TELEFONE1,'#13#10'    r.TELEFONE2, r.DDD_CEL_PARTICULAR, r.CEL_PA' +
      'RTICULAR, r.DDD_CEL_EMPRESA,'#13#10'    r.CEL_EMPRESA, r.SEXO, r.DTNAS' +
      'C, r.ESTADO_CIVIL, r.PROFISSAO, r.OBS, r.CEP,'#13#10'    r.UF, r.CIDAD' +
      'E, r.ENDERECO, r.COMPLEMENTO, r.NUMERO, r.BAIRRO, r.SITUACAO,'#13#10' ' +
      '   cast(r.PERCENT_COMISSAO as numeric(8,3))PERCENT_COMISSAO, cas' +
      't(r.META as numeric(10,2))META, '#13#10'    r.DT_ADMISSAO, r.BANCO_NOM' +
      'E, r.BANCO_AGENCIA,'#13#10'    r.BANCO_CONTA'#13#10'FROM REPRESENTANTE r'#13#10'wh' +
      'ere 1 = 2'
    ...
    object cdsDDD_CEL_PARTICULAR: TStringField
      FieldName = 'DDD_CEL_PARTICULAR'
      FixedChar = True
      Size = 3
    end
    object cdsCEL_PARTICULAR: TStringField
      FieldName = 'CEL_PARTICULAR'
      Origin = 'CEL_PARTICULAR'
      Size = 15
    end
    object cdsDDD_CEL_EMPRESA: TStringField
      FieldName = 'DDD_CEL_EMPRESA'
      FixedChar = True
      Size = 3
    end
    object cdsCEL_EMPRESA: TStringField
      FieldName = 'CEL_EMPRESA'
      Origin = 'CEL_EMPRESA'
      Size = 15
    end
    ...
    object cdsDT_ADMISSAO: TDateField
    ...
    object cdsPERCENT_COMISSAO: TCurrencyField
      FieldName = 'PERCENT_COMISSAO'
      DisplayFormat = '#,##0.000'
    end
    object cdsMETA: TFMTBCDField
      FieldName = 'META'
      ReadOnly = True
      DisplayFormat = '#,##0.000'
      Precision = 18
