...
--------------------------------------------------------------------------------
Installation
* Open the run-time package (X=Delphi version) ExcelExportPackX.dproj and build it
* Open the design-time package (X=Delphi version) dclExcelExportPackX.dproj and compile and install it
...
* When you like to add the component to an existing package, add the unit
  ...
  This file can be found in Embarcadero\RAD Studio\x.0\Lib folder.
...
begin
  ...
  case Index of
    0 :
      begin
        MessageDlg('TscExcelExport 4.42'+#13+#10+'Stefan Cruysberghs'+#13+#10+
          'October 2021'+#13+#10+
