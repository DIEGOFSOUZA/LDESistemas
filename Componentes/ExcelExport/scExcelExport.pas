...
* Description : TscExcelExport
  ...
  which enables you to export all records of a dataset from Embarcadero Delphi
  ...
  This VLC component works in Delphi 5, 6, 7, 2006, 2007, 2009, 2010, XE, XE2, XE3, XE4, XE5, XE6, XE7, XE8, 
  10 Seattle, 10.1 Berlin, 10.2 Tokyo, 10.3 Rio, 10.4 Sydney, 11 Alexandria & Community Edition.
  and it supports Excel 97, 2000, XP, 2003, 2007, 2010, 2013, 2016 and 2019/365.

* Dates : February 2000 - October 2021
* Version : 4.42
...
* The registration cost is 35 EURO (single developer license)
  and 130 EURO (site license (unlimited developers))
* You can register the component by paying via PayPal by clicking on the Send button
  Please provide company or user name and emailadress
  https://www.paypal.com/paypalme/StefanCruysberghs/130EUR (site license)
  https://www.paypal.com/paypalme/StefanCruysberghs/35EUR (single developer license)
---------------------------------------------------------------------------------------------------------------------------------
Installation

* Step1: Open the run-time package ExcelExportPackX.dproj and build it
  ...
  Embarcadero Delphi 10.1 Berlin    ExcelExportPackD101
  Embarcadero Delphi 10.2 Tokyo     ExcelExportPackD102
  Embarcadero Delphi 10.3 Rio     	ExcelExportPackD103
  Embarcadero Delphi 10.4 Sydney   	ExcelExportPackD104
  Embarcadero Delphi 11 Alexandria 	ExcelExportPackD11
  
* Step 2: Open the design-time package dclExcelExportPackX.dproj and Build/Compile it. 
...
* Make sure to add a path to the folder where the scExcelExport.pas file is located in the global Library path 
...
* The 2 live templates (ExcelExportCreate.xml and ExcelExportUse.xml) should be copied to
  ...
  Delphi 10.1   C:\Program Files\Embarcadero\RAD Studio\18.0\ObjRepos\en\Code_Templates\Delphi
  Delphi 10.2   C:\Program Files\Embarcadero\RAD Studio\19.0\ObjRepos\en\Code_Templates\Delphi
  Delphi 10.3   C:\Program Files\Embarcadero\RAD Studio\20.0\ObjRepos\en\Code_Templates\Delphi
  Delphi 10.4   C:\Program Files\Embarcadero\RAD Studio\21.0\ObjRepos\en\Code_Templates\Delphi
  Delphi 11     C:\Program Files\Embarcadero\RAD Studio\22.0\ObjRepos\en\Code_Templates\Delphi
...
* Excel 2010 is de default type library for all Delphi version since XE2
...
Delphi         |  11   |  10   |  XE8  |  XE7  |  XE6  |  XE5  |  XE4  |   XE3 |   XE2 |   XE  |  2010 |  2009 |  2007 | Turbo |  2006 |  2005 |   7   |   6   | 5 SP1 |
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Excel2010.pas  |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |       |       |       |       |       |       |       |       |       |       |
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ExcelXP.pas    |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |   x   |       |       |
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
* The pas files can be found in
  ...
  Delphi 10.2   C:\Program Files\Embarcadero\RAD Studio\19.0\OCX\Servers\pas2010
  Delphi 10.3   C:\Program Files\Embarcadero\RAD Studio\20.0\OCX\Servers\pas2010
  Delphi 10.4	C:\Program Files\Embarcadero\RAD Studio\21.0\OCX\Servers\pas2010
  Delphi 11   	C:\Program Files\Embarcadero\RAD Studio\22.0\OCX\Servers\pas2010
...
--------------------------------------------------------------------------------
Excel97.pas    |   x   |   x   |   x    |   x   |   x   |   x   |   x   |   x   |
--------------------------------------------------------------------------------

* See the Microsoft documentation for all classes, properties, methods and events 
  of the OCX/COM/OLE library of Excel:
  https://docs.microsoft.com/en-us/dotnet/api/microsoft.office.tools.excel
...
type
  ...
  /// <Summary>
  /// Which Excel version is registered as default ?
  /// </Summary>
  TExcelVersion = (
    /// <Summary>
    /// Excel 97
  ...
  TFileFormat = (
    ...
    ffXLSX,
    /// <Summary>
    /// XLSM (Open XML format macro enabled) of Excel 2007
    // (ZIP container for packaging XML and other data files)
    /// </Summary>
    ffXLSM,
    /// <Summary>
  ...
  /// <Summary>
  /// Horizontal Alignment of content in cell
  /// </Summary>
  THAlignment = (haGeneral, haLeft, haRight, haCenter, haDistributed, haFill, haJustify);

  /// <Summary>
  /// Horizontal Alignment of content in cell
  /// </Summary>
  TVAlignment = (vaBottom, vaCenter, vaTop, vaDistributed, vaJustify);
  ...
  TxlFont = class(TFont)
  private
    FHorizontalAlignment: THAlignment;
    FVerticalAlignment: TVAlignment;
    FBlnWrapText: Boolean;
    FIntOrientation: Integer;
  published
    /// <Summary>
    /// Horizontal alignment of text in cell
    /// </Summary>
    property Alignment: THAlignment read FHorizontalAlignment write FHorizontalAlignment;
    /// <Summary>
    /// Horizontal alignment of text in cell
    /// </Summary>
    property VerticalAlignment: TVAlignment read FVerticalAlignment write FVerticalAlignment;
    /// <Summary>
  ...
  /// Rows : Excel 2019/2016/2013/2010/2007 (only .XLSX) = 16384 (2^14)
  /// Rows : Excel 2010/2007/2003/XP/2000/97 (.XLS) = 256 (2^8)
  /// Columns : Excel 2019/2016/2013/2010/2007 (only .XLSX) = 1048576 (2^20)
  /// Columns : Excel 2010/2007/2003/XP/2000/97 (.XLS) = 65536 (2^16)
  /// Cell : Excel 2019/2016/2013/2010/2007 : 99999
  /// Cell : Excel 2003/XP/2000/97 : 910
  /// </Summary>
  ...
  public
    ...
    /// <Summary>
    /// Default Excel version (8=97 9=2000 10=2002, 11=2003, 12=2007, 14=2010, 15=2013, 16:2016/2019/365)
    /// </Summary>
...
begin
  ...
  begin
    ...
    // - Excel 2007-2019 : Calibri, size 11

    FFontHeader.Alignment := haGeneral;
    FFontHeader.VerticalAlignment := vaCenter;
    FFontHeader.Name := '';
    FFontHeader.Size := -1;
    ...
    FFontData.Alignment := haGeneral;
    FFontData.VerticalAlignment := vaCenter;
    FFontData.Name := '';
    FFontData.Size := -1;
    ...
    FFontSummary.Alignment := haGeneral;
    FFontSummary.VerticalAlignment := vaCenter;
    FFontSummary.Name := '';
    FFontSummary.Size := -1;
    ...
    FFontTitles.Alignment := haGeneral;
    FFontTitles.VerticalAlignment := vaCenter;
    FFontTitles.Name := '';
    FFontTitles.Size := -1;
    ...
    FFontGroup.Alignment := haGeneral;
    FFontGroup.VerticalAlignment := vaCenter;
    FFontGroup.Name := '';
    FFontGroup.Size := -1;
    ...
    FFontFooter.Alignment := haGeneral;
    FFontFooter.VerticalAlignment := vaCenter;
    FFontFooter.Name := '';
    FFontFooter.Size := -1;
...
const
  vHorizontalAlignment : array[THAlignment] of XlHAlign =
    (xlHAlignGeneral, xlHAlignLeft, xlHAlignRight, xlHAlignCenter, xlHAlignDistributed, xlHAlignFill, xlHAlignJustify);
  ...
  vVerticalAlignment : array[TVAlignment] of XlVAlign =
    (xlVAlignBottom, xlVAlignCenter, xlVAlignTop, xlVAlignDistributed, xlVAlignJustify);
...
begin
  ...
  FExcelWorksheet.Range[StrBeginCell, StrEndCell].HorizontalAlignment := TOleEnum(vHorizontalAlignment[DelphiFont.Alignment]);
  FExcelWorksheet.Range[StrBeginCell, StrEndCell].VerticalAlignment := TOleEnum(vVerticalAlignment[DelphiFont.VerticalAlignment]);
end;
...
begin
  ...
  // 8=97 9=2000 10=2002, 11=2003, 12=2007, 14=2010, 15=2013, 16=2016/2019
...
begin
  Result := FieldDataType[IntFieldIndex] in
    ...
    {$IFDEF DELPHI2010ORNEWER} ftSingle, {$ENDIF}
    {$IFDEF DELPHI2010ORNEWER} ftByte, {$ENDIF}
...
//------------------------------------------------------------------------------
// Excel 2007-2019 XLSX   | 1048576 (2^20) |  16384 (2^14) |
...
begin
  Result := 99;
  Regist := TRegistry.Create(KEY_ALL_ACCESS OR KEY_WOW64_64KEY);
  try
    Regist.RootKey := Windows.HKEY_CURRENT_USER;
    if Regist.OpenKey('\Software\Microsoft\Office\16.0\Excel', true) then
      Result := 16 //2016/2019/365
    else if Regist.OpenKey('\Software\Microsoft\Office\15.0\Excel', true) then
      Result := 15 //2013
    else if Regist.OpenKey('\Software\Microsoft\Office\14.0\Excel', true) then
      Result := 14 //2010
    else if Regist.OpenKey('\Software\Microsoft\Office\12.0\Excel', true) then
      Result := 12 //2007
    else if Regist.OpenKey('\Software\Microsoft\Office\11.0\Excel', true) then
      Result := 11 //2003
    else if Regist.OpenKey('\Software\Microsoft\Office\10.0\Excel', true) then
      Result := 10 //XP
    else if Regist.OpenKey('\Software\Microsoft\Office\9.0\Excel', true) then
      Result := 9 //2000
    else if Regist.OpenKey('\Software\Microsoft\Office\8.0\Excel', true) then
      Result := 8; //97
    Regist.CloseKey;
  finally
    Regist.Free;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if (MatrixStyles[i,j,CONST_FONTBOLD] <> (fsBold in FFontData.Style)) then
          FExcelWorksheet.Range[StrCell,StrCell].Font.Bold := MatrixStyles[i,j,CONST_FONTBOLD];
        if (MatrixStyles[i,j,CONST_FONTITALIC] <> (fsItalic in FFontData.Style)) then
          FExcelWorksheet.Range[StrCell,StrCell].Font.Italic := MatrixStyles[i,j,CONST_FONTITALIC];
        if (MatrixStyles[i,j,CONST_FONTUNDERLINE] <> (fsUnderline in FFontData.Style)) then
          FExcelWorksheet.Range[StrCell,StrCell].Font.Underline := MatrixStyles[i,j,CONST_FONTUNDERLINE];
        if (MatrixStyles[i,j,CONST_WRAPTEXT] <> FFontData.WrapText) then
          FExcelWorksheet.Range[StrCell,StrCell].WrapText := FFontData.WrapText;
        if (MatrixStyles[i,j,CONST_ORIENTATION] <> FFontData.Orientation) then
          FExcelWorksheet.Range[StrCell,StrCell].Orientation := FFontData.Orientation;
        if (MatrixStyles[i,j,CONST_HALIGNMENT] <> FFontData.Alignment) then
          FExcelWorksheet.Range[StrCell,StrCell].HorizontalAlignment := TOleEnum(vHorizontalAlignment[THAlignment(MatrixStyles[i,j,CONST_HALIGNMENT])]);
        if (MatrixStyles[i,j,CONST_VALIGNMENT] <> FFontData.VerticalAlignment) then
          FExcelWorksheet.Range[StrCell,StrCell].VerticalAlignment := TOleEnum(vVerticalAlignment[TVAlignment(MatrixStyles[i,j,CONST_VALIGNMENT])]);
      end;
    end;
  end;
...
begin
  ...
  try
    ...
    if IsColorEventAssigned then
      MatrixStyles := VarArrayCreate([1,FIntBlockOfRecords,1,FSLFieldNames.Count,1,CONST_VALIGNMENT],varVariant);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            MatrixStyles[IntMatrixRow,IntColumn,CONST_FONTBOLD]:=fsBold in FontCell.Style;
            MatrixStyles[IntMatrixRow,IntColumn,CONST_FONTITALIC]:=fsItalic in FontCell.Style;
            MatrixStyles[IntMatrixRow,IntColumn,CONST_FONTUNDERLINE]:=fsUnderline in FontCell.Style;
            MatrixStyles[IntMatrixRow,IntColumn,CONST_HALIGNMENT]:=FontCell.Alignment;
            MatrixStyles[IntMatrixRow,IntColumn,CONST_WRAPTEXT]:=FontCell.WrapText;
            MatrixStyles[IntMatrixRow,IntColumn,CONST_ORIENTATION]:=FontCell.Orientation;
            MatrixStyles[IntMatrixRow,IntColumn,CONST_VALIGNMENT]:=FontCell.VerticalAlignment;
           end;
        end
...
begin
  ...
  case FileFormat
   of
    ...
    //  2000/XP/2003 -> XLS
    //  2007/2010/2013/2016/2019 -> XLSX (Open XML)
    ffDefault : FExcelWorksheet.SaveAs(StrFileName);
    // Excel 2007-2019 Open XML format (file extension XLSX)
    ffXLSX :
      begin
        if FIntExcelVersion >= 12 then
    ...
    // Excel 2007-2019 Open XML format with macro enabled(file extension XLSM)
    ffXLSM :
      begin
        if FIntExcelVersion >= 12 then
          FExcelWorksheet.SaveAs(StrFileName, XlFileFormat(xlOpenXMLWorkbookMacroEnabled))
        else
          raise ENotSupported.Create(rsNotSupported);
      end;	  
    ...
    // HTML
    // Works with all Excel versions since 2000
    ffHTM :
      begin
        if FIntExcelVersion >= 9 then
    ...
    // XML spreadsheet
    // Works with all Excel versions since XP
    ffXML :
      begin
