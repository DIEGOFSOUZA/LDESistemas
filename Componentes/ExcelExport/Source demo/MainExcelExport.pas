{--------------------------------------------------------------------------------
* Description : Demo application that shows all features of the TscExcelExport component
* Author : Stefan Cruysberghs
* Email : stefancr@scip.be
* Website : http://www.scip.be

* To run this application, Excel should be installed.
* Make sure to add a path to the folder with the scExcelExport.pas file
in the global Library path of Delphi
 - Tools >> Options >> Delphi Options >> Library >> Library path
 - or Tools >> Options >> Language >> Delphi >> Library >> Library path
--------------------------------------------------------------------------------}
...
uses
  ...
  StdCtrls, Db, Grids, DBGrids, ExtCtrls, Buttons,
  ComCtrls, OleServer, ImgList, DBClient,
  scExcelExport,
  {$IFDEF DELPHXEORHIGHER}
  System.ImageList,
  {$ENDIF}
  {$IFNDEF DELPHI5}
  Variants, jpeg, XPMan, System.ImageList, Vcl.Imaging.pngimage,
  {$ENDIF}
  {$IFDEF EXCEL97}
  Excel97;
  {$ENDIF}
...
type
  TFormExcelExport = class(TForm)
    ...
    TabSheetDatasetOrders: TTabSheet;
    TabSheetDatasetAnimals: TTabSheet;
    PanelOrders: TPanel;
    DBGridOrders: TDBGrid;
    DBGridAnimals: TDBGrid;
    PanelAnimals: TPanel;
    TabSheetDatasetBiolife: TTabSheet;
    PanelBiolife: TPanel;
    DBGridBiolife: TDBGrid;
    TabSheetDatasetShipVia: TTabSheet;
    PanelSortShipVia: TPanel;
    DBGridShipVia: TDBGrid;
    DataSourceShipVia: TDataSource;
    TabSheet3: TTabSheet;
    TabSheet4: TTabSheet;
    TabSheet5: TTabSheet;
    TabSheet6: TTabSheet;
    ...
    ClientDataSetAnimals: TClientDataSet;
    ClientDataSetBiolife: TClientDataSet;
    ClientDataSetOrders: TClientDataSet;
    ClientDataSetAnimalsNAME: TStringField;
    ClientDataSetAnimalsSIZE: TSmallintField;
    ClientDataSetAnimalsWEIGHT: TSmallintField;
    ClientDataSetAnimalsAREA: TStringField;
    ClientDataSetAnimalsBMP: TBlobField;
    ClientDataSetAnimalsWeightSize: TFloatField;
    ClientDataSetAnimalsAreaText: TStringField;
    ClientDataSetAnimalsSizeText: TStringField;
    ClientDataSetAnimalsWeight2: TFloatField;
    ClientDataSetAnimalsWeight3: TFloatField;
    ClientDataSetAnimalsWeight4: TStringField;
    ClientDataSetAnimalsWeight5: TCurrencyField;
    ClientDataSetAnimalsWeight6: TCurrencyField;
    ClientDataSetAnimalsWeight7: TFloatField;
    ClientDataSetAnimalsTime1: TDateTimeField;
    ClientDataSetAnimalsTime2: TDateTimeField;
    ClientDataSetAnimalsTime3: TDateTimeField;
    ClientDataSetAnimalsTime4: TDateTimeField;
    ClientDataSetAnimalsTime5: TDateTimeField;
    ClientDataSetAnimalsTime6: TDateField;
    ClientDataSetBiolifeSpeciesNo: TFloatField;
    ClientDataSetBiolifeCategory: TStringField;
    ClientDataSetBiolifeCommon_Name: TStringField;
    ClientDataSetBiolifeSpeciesName: TStringField;
    ClientDataSetBiolifeLengthcm: TFloatField;
    ClientDataSetBiolifeLength_In: TFloatField;
    ClientDataSetBiolifeNotes: TMemoField;
    ClientDataSetBiolifeGraphic: TGraphicField;
    ClientDataSetOrdersOrderNo: TFloatField;
    ClientDataSetOrdersCustNo: TFloatField;
    ClientDataSetOrdersSaleDate: TDateTimeField;
    ClientDataSetOrdersShipDate: TDateTimeField;
    ClientDataSetOrdersEmpNo: TIntegerField;
    ClientDataSetOrdersShipToContact: TStringField;
    ClientDataSetOrdersShipToAddr1: TStringField;
    ClientDataSetOrdersShipToAddr2: TStringField;
    ClientDataSetOrdersShipToCity: TStringField;
    ClientDataSetOrdersShipToState: TStringField;
    ClientDataSetOrdersShipToZip: TStringField;
    ClientDataSetOrdersShipToCountry: TStringField;
    ClientDataSetOrdersShipToPhone: TStringField;
    ClientDataSetOrdersShipVIA: TStringField;
    ClientDataSetOrdersPO: TStringField;
    ClientDataSetOrdersTerms: TStringField;
    ClientDataSetOrdersPaymentMethod: TStringField;
    ClientDataSetOrdersItemsTotal: TCurrencyField;
    ClientDataSetOrdersTaxRate: TFloatField;
    ClientDataSetOrdersFreight: TCurrencyField;
    ClientDataSetOrdersAmountPaid: TCurrencyField;
    ClientDataSetShipVia: TClientDataSet;
    ClientDataSetShipViaShipVia: TStringField;
    ClientDataSetShipViaTerms: TStringField;
    ClientDataSetShipViaOrderNo: TFloatField;
    ClientDataSetShipViaCustNo: TFloatField;
    ClientDataSetShipViaSaleDate: TDateTimeField;
    ClientDataSetShipViaNewOrderNo: TFloatField;
    ClientDataSetShipViaAmountPaid: TCurrencyField;
    ...
    procedure ClientDataSetAnimalsCalcFields(DataSet: TDataSet);
    procedure ClientDataSetBiolifeNotesGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
  private
...
begin
  ...
  begin
    ...
    begin
      ...
      FontCell.Size := 14;
      FontCell.Alignment := haLeft;
      FontCell.VerticalAlignment := vaTop;
    end;
...
procedure TFormExcelExport.ClientDataSetAnimalsCalcFields(DataSet: TDataSet);
var
  StrSize : String;
  IntLength : Integer;
begin
...
procedure TFormExcelExport.ClientDataSetBiolifeNotesGetText(Sender: TField;
...
begin
  ...
  ClientDataSetAnimals.LoadFromFile(GetCurrentDir + '\Data\Animals.cds');
  ClientDataSetBiolife.LoadFromFile(GetCurrentDir + '\Data\Biolife.cds');
  ClientDataSetOrders.LoadFromFile(GetCurrentDir + '\Data\Orders.cds');
  ClientDataSetShipVia.LoadFromFile(GetCurrentDir + '\Data\ShipVia.cds');
end;

procedure TFormExcelExport.scExcelExport2GetEOF(Sender: TObject; var BlnEOF: Boolean);
begin
  BlnEOF := ClientDatasetShipVia.Eof;
end;

procedure TFormExcelExport.scExcelExport2GetFieldCount(Sender: TObject;
  var IntFieldCount: Integer);
begin
  IntFieldCount := ClientDatasetShipVia.FieldCount;
end;

procedure TFormExcelExport.scExcelExport2GetFieldDataSize(Sender: TObject;
  const FieldIndex: Integer; var IntFieldDataSize: Integer);
begin
  IntFieldDataSize := ClientDatasetShipVia.Fields[FieldIndex].Size;
end;

procedure TFormExcelExport.scExcelExport2GetFieldDataType(Sender: TObject;
  const FieldIndex: Integer; var FieldDataType: TFieldType);
begin
  FieldDataType := ClientDatasetShipVia.Fields[FieldIndex].DataType;

  if SameText(ClientDatasetShipVia.Fields[FieldIndex].FieldName,'NewOrderNo') then
    FieldDataType := ftString;
  if SameText(ClientDatasetShipVia.Fields[FieldIndex].FieldName,'SaleDate') then
...
begin
  StrFieldDisplayName := '* '+ClientDatasetShipVia.Fields[FieldIndex].FieldName+' *';
end;

procedure TFormExcelExport.scExcelExport2GetFieldName(Sender: TObject;
  const FieldIndex: Integer; var StrFieldName: String);
begin
  StrFieldName := ClientDatasetShipVia.Fields[FieldIndex].FieldName;
end;

procedure TFormExcelExport.scExcelExport2GetFieldValue(Sender: TObject;
  const FieldIndex: Integer; var VarValue: Variant);
begin
  VarValue := ClientDatasetShipVia.Fields[FieldIndex].Value;

  if SameText(ClientDatasetShipVia.Fields[FieldIndex].FieldName,'NewOrderNo') then
    VarValue := '00'+ClientDatasetShipVia.Fields[FieldIndex].AsString;
end;

procedure TFormExcelExport.scExcelExport2GotoFirstRecord(Sender: TObject);
begin
  ClientDatasetShipVia.First;
end;

procedure TFormExcelExport.scExcelExport2GotoNextRecord(Sender: TObject);
begin
  ClientDatasetShipVia.Next;
end;
...
begin
  if ClientDatasetShipVia.FieldByName('OrderNo').Value < 1010 then
    ColorBackground := clYellow;

  if IntFieldIndex = 4 then
  begin
    if ClientDatasetShipVia.FieldByName('CustNo').Value > 2000 then
    begin
      FontCell.Color := clRed;
      FontCell.Style := [fsItalic];
      FontCell.Size  := 14;
...
begin
  try
    ...
    scExcelExport1.Dataset:=ClientDatasetOrders;
...
begin
  try
    scExcelExport1.ExcelVisible:=True;
    scExcelExport1.LoadDefaultProperties;
    scExcelExport1.Dataset:=ClientDatasetAnimals;
    ClientDatasetAnimalsBMP.Visible := false;
    ...
    scExcelExport1.Disconnect;
    ClientDatasetAnimalsBMP.Visible := true;
  end;
end;
...
begin
  try
    scExcelExport1.ExcelVisible:=True;
    scExcelExport1.LoadDefaultProperties;
    scExcelExport1.Dataset:=ClientDatasetBiolife;
...
begin
  try
    ...
    Duration := Now();
    ClientDatasetBiolifeNotes.OnGetText := ClientDatasetBiolifeNotesGetText;
    scExcelExport1.ExportDataset;
    StatusBar.Panels[1].Text := 'Duration : '+TimeToStr(Now() - Duration);

    ClientDatasetOrdersShipToPhone.Index := 10;
  finally
    ClientDatasetBiolifeNotes.OnGetText := nil;
    scExcelExport1.Disconnect;
  end;
end;
...
begin
  try
    ...
    ClientDatasetOrdersShipToContact.Visible := False;
    ClientDatasetOrdersShipToAddr1.Visible := False;
    ClientDatasetOrdersShipToAddr2.Visible := False;
    ClientDatasetOrdersShipToCity.Visible := False;
    ClientDatasetOrdersShipToState.Visible := False;
    ClientDatasetOrdersShipToZip.Visible := False;
    ClientDatasetOrdersShipToCountry.Visible := False;
    ClientDatasetOrdersShipToPhone.Visible := False;
    ClientDatasetOrdersShipVIA.Visible := False;
    ClientDatasetOrdersPO.Visible := False;
    ClientDatasetOrdersTerms.Visible := False;
    Duration := Now();
    scExcelExport1.ExportDataset;
    StatusBar.Panels[1].Text := 'Duration : '+TimeToStr(Now() - Duration);
  finally
    ClientDatasetOrdersShipToContact.Visible := True;
    ClientDatasetOrdersShipToAddr1.Visible := True;
    ClientDatasetOrdersShipToAddr2.Visible := True;
    ClientDatasetOrdersShipToCity.Visible := True;
    ClientDatasetOrdersShipToState.Visible := True;
    ClientDatasetOrdersShipToZip.Visible := True;
    ClientDatasetOrdersShipToCountry.Visible := True;
    ClientDatasetOrdersShipToPhone.Visible := True;
    ClientDatasetOrdersShipVIA.Visible := True;
    ClientDatasetOrdersPO.Visible := True;
    ClientDatasetOrdersTerms.Visible := True;
    scExcelExport1.Disconnect;
  end;
end;
...
begin
  ...
  intRecords := 100;
  intSheetcount := 1;
  while not ClientDatasetOrders.IsEmpty do
  begin
    ClientDatasetOrders.Filtered := False;
    ClientDatasetOrders.Filter := 'OrderNo > ' + IntToStr(intOrderNo) + ' AND OrderNo < ' + IntToStr(intOrderNo+intRecords);
    ClientDatasetOrders.Filtered := True;
...
begin
  try
    scExcelExport1.ExcelVisible:=True;
    scExcelExport1.LoadDefaultProperties;
    scExcelExport1.Dataset:=ClientDatasetShipVia;
    ...
    scExcelExport1.FontHeader.VerticalAlignment := vaTop;
...
begin
  try
    ClientDatasetOrders.DisableControls;
    ClientDatasetOrders.First;
	...
	scExcelExport2.WorksheetName:='TscExcelExport DEMO 16';
    Duration := Now();
    scExcelExport2.ExportDataset;
    StatusBar.Panels[1].Text := 'Duration : '+TimeToStr(Now() - Duration);
  finally
    scExcelExport2.Disconnect;
    ClientDatasetOrders.EnableControls;
  end;
end;
...
begin
  ...
  scExcelExport1.ExcelWorkSheet.Range['A1','A1'].Value2 := StrToDate('31/01/2019');
